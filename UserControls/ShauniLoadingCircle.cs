...
namespace Shauni.UserControls
{
    public partial class LoadingCircle : Control
    {
        ...
        private const int ShauniInnerCircleRadius = 11;
        private const int ShauniOuterCircleRadius = 10;
        private const int ShauniNumberOfSpoke = 45;
        private const int ShauniSpokeThickness = 2;
        ...
        public int OuterCircleRadius
        {
            get
            {
                if (m_OuterCircleRadius == 0)
                    m_OuterCircleRadius = ShauniOuterCircleRadius;
        ...
        public int InnerCircleRadius
        {
            get
            {
                if (m_InnerCircleRadius == 0)
                    m_InnerCircleRadius = ShauniInnerCircleRadius;
        ...
        public int NumberSpoke
        {
            get
            {
                if (m_NumberOfSpoke == 0)
                    m_NumberOfSpoke = ShauniNumberOfSpoke;
        ...
        public int SpokeThickness
        {
            get
            {
                if (m_SpokeThickness <= 0)
                    m_SpokeThickness = ShauniSpokeThickness;
        ...
        System.ComponentModel.Category("LoadingCircle"), DefaultValue(30)]
        ...
        public StylePresets StylePreset
        {
            ...
            set
            {
                ...
                {
                    case StylePresets.Shauni:
                        SetCircleAppearance(ShauniNumberOfSpoke,
                            ShauniSpokeThickness, ShauniInnerCircleRadius,
                            ShauniOuterCircleRadius);
                        break;
                }
            }
        }
        ...
        {
            proposedSize.Width =
                (m_OuterCircleRadius + m_SpokeThickness);
